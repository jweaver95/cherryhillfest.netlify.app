...
const currentPartners: { id: string; name: string; tier: string; logo_url: string; website: string; description: string; order_index: number; dark_bg?: boolean }[] = [
  ...
  },
  {
    ...
    tier: 'Platinum',
    logo_url: '/BC_Recs_%26_Parks_simple_logo_lo_res_.jpg',
    website: '',
    description: '',
    order_index: 3,
  },
  {
    ...
    tier: 'Platinum',
    logo_url: '/Orange-Barrel-Media_7F851A69-5056-BF65-D6ECDFFCC2B83C5F-7f8519ee5056bf6_7f851cc9-5056-bf65-d63896db09863a91.jpg',
    website: '',
    description: '',
    order_index: 4,
  },
  ...
  },
  {
    ...
    tier: 'Gold',
    logo_url: '/Switching_Lanes_logo_%28white_background%29.png',
    website: '',
    description: '',
    order_index: 6,
  },
  {
    ...
    tier: 'Gold',
    logo_url: '/MSAC_Color_Horizontal_text.png',
    website: '',
    description: '',
    order_index: 7,
  },
  ...
  {
    id: 'spu-01',
    name: 'Spitcam University',
    tier: 'Silver',
    logo_url: '/SpitcamUniversistyLogo_Black.png',
    website: '',
    description: '',
    order_index: 9,
  },
  {
    ...
    tier: 'Silver',
    logo_url: '/ABC_Transparent_Logo.png',
    website: '',
    description: '',
    order_index: 10,
  },
  {
    ...
    tier: 'Bronze',
    logo_url: '/Cherry_Hill_Community_Coalition_%28CHCC%29_Logo.jpeg',
    website: '',
    description: '',
    order_index: 11,
  },
  ...
  {
    id: 'bcj-01',
    name: 'Black Child Journal',
    tier: 'Bronze',
    logo_url: '/Black_Child_Journal_Logo.png',
    website: '',
    description: '',
    order_index: 13,
  },
  {
    id: 'lyric-01',
    name: 'Lyric Baltimore Education',
    tier: 'Bronze',
    logo_url: '/Lyric_Baltimore_Education_logo_copy.jpeg',
    website: '',
    description: '',
    order_index: 14,
  },
  {
    id: 'chfc-01',
    name: 'Cherry Hill Family Congress',
    tier: 'Bronze',
    logo_url: '/Cherry_Hill_Family_Congress_Logo.png',
    website: '',
    description: '',
    order_index: 15,
  },
